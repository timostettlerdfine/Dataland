---
applyTo: "dataland-frontend/**"
description: "Frontend and UX conventions for Dataland. Applied automatically to all files under dataland-frontend/. Covers PrimeVue usage, CSS/SCSS rules, TypeScript in Vue, URL conventions, and the Framework Data View Page pattern."
---

# 🎨 Frontend and UX Overview
...
* [Common VueJs Mistakes and How to Avoid Them](https://vueschool.io/courses/common-vue-js-mistakes-and-how-to-avoid-them) - A free and strongly recommended video course on the most common mistakes in coding Vue.
...
Sometimes we want to adjust the display of one specific kind of value (e.g. the display of percentage-number-fields). Whenever we do this, we do this for _all_ frameworks.
